---
id: 20260907-4090-分段耗时-pi05-g1d-fp16-3-相机-prefix-968-10-步去噪-阶段-p50-ms-mean-ms-p95-ms-占
title: 4090 分段耗时（pi05 G1D fp16，3 相机，prefix 968，10 步去噪） 阶段 p50 (ms) mean (ms) p95 (ms) 占
type: raw
summary:
tags: []
status: draft
